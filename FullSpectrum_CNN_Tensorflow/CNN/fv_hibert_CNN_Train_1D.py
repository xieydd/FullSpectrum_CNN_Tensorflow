# -*- coding: utf-8 -*-
"""
Created on Tue Jan  9 15:18:00 2018

E-mail: xieydd@gmail.com

@author: xieydd

@description:一维全矢卷积神经网络训练
"""
...
from fv_hibert_CNN_Model_1D import FV_Hilbert_CNNConfig,FV_Hilbert_CNN
...
def train(signal,labels):
    ...
    required_improved = 1000   #如果超过1000次不提升就提前结束
    ...
    for epoch in range(config.num_epochs):
        ...
        for x_batch,y_batch in train_batch:
            x_batch = np.reshape(x_batch,[-1,1024,1])
            ...
            x_train_reshaped = np.reshape(x_train,[-1,1024,1])
